...
for run_number in run_numbers:
    ...
    print(f'../mgt{run_number}.evt', f'./test/{run_number}_mana.xml', 'dc_ldndc_lookup.csv')
    ...
    dcldndc.convert_sch_mana(f'../mgt{run_number}.evt', f'./test/{run_number}_mana.xml', f'../dirComad{run_number}.in', '../harv.100', 'dc_ldndc_lookup.csv')
